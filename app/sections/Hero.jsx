  ...
  return (
    <div className="flex justify-center flex-col items-center gap-8 mb-32">
      <div className="flex flex-col items-center">
        <h1 className="hidden md:block md:w-[64vw] md:text-[66px] leading-[39px] md:leading-[62px] text-center pb-6 tracking-[-4%]">
          We create designs & <span>websites</span> <br/> for growing <span className="font-goudy italic text-[36px] md:text-[68px]">businesses</span>
        </h1>
        <h1 className="md:hidden text-[34px] md:w-[64vw] md:text-[66px] leading-[39px] md:leading-[62px] text-center pb-6 tracking-[-4%]">
          We create designs &<br/> websites for<br/> growing <span className="font-goudy italic text-[36px] md:text-[68px]">businesses</span>
        </h1>
