...
const pricingOptions = [
  {
    ...
    bgColor: 'bg-[#151515]',
    color : "text-[#FF9000]",
    button : <Button variant="secondary" className="mt-6 w-full text-white py-3 rounded-[20px]">Start a project</Button>
  },
  {
  ...
  },
  {
    ...
    button : <Button className="mt-6 w-full py-3 rounded-[20px]">Book a free call <BsArrowUpRight/> </Button>
  }
];
