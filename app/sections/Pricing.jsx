...
const pricingOptions = [
  ...
  },
  {
    ...
    features: [
      'All Web Design features',
      'All Brand & Logo Design features',
    ...
    button: (
      <a href="https://calendly.com/10thgriddesigns/30min" target="_blank" rel="noopener noreferrer">
        <Button className="mt-6 w-full py-3 rounded-[20px]">
  ...
  return (
    <section className="py-20 px-6 flex flex-col mb-32 items-center" id="pricing">
      <Heading
        ...
        className="max-w-[270px] md:max-w-[450px] pb-14"
      />
      ...
      <div className="flex flex-col md:flex-row gap-10">
        {pricingOptions.map((option, index) => (
          <div
            key={index}
            className={`w-[360px] md:w-[368px] px-4 md:px-5 pt-6 pb-4 rounded-[33px] text-white shadow-md flex flex-col justify-between ${option.bgColor}`}
            style={
              index === 2
                ? {
                    background: 'linear-gradient(200deg, #000000 35%, #362A00 85%, #362A00 95%)',
